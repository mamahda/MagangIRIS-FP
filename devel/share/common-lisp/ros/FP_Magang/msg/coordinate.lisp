...
(cl:defmethod cl:initialize-instance :after ((m <coordinate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'coordinate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name FP_Magang-msg:<coordinate> is deprecated: use FP_Magang-msg:coordinate instead.")))
